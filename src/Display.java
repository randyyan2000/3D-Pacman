...
//              ((Math.signum(ayo)==Math.signum(byo)) && (Math.signum(axo)==0 || Math.signum(bxo)==0))
                    )
                    {
                        ...
                        if (d == Ghost.UP) {
                            ayn += 30;
                            byn += 30;
                        } else if (d == Ghost.DOWN) {
                            ayn -= 30;
                            byn -= 30;
                        } else if (d == Ghost.LEFT) {
                            axn += 30;
                            bxn += 30;
                        } else if (d == Ghost.RIGHT) {
                            axn -= 30;
                            bxn -= 30;
                        }
...
//            if((Math.signum(axo)==Math.signum(bxo) && Mat
    ...
    {
        d[Ghost.oppositeDirection(direction)]=false;
        ArrayList<Integer> validD = new ArrayList<>();
        int c = 0;
        for(int i = 0; i < 4; i++) {
...
//        System.out.println(i);
        return validD.get((int) (Math.random() * validD.size()));
    }
